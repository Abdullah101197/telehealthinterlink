...
class WebsiteController extends Controller
{
    ...
    {
        $request->validate([
            'doc_name' => 'required|unique:doctor,name',
            'doc_email' => 'required|email|unique:users,email',
            'doc_dob' => 'required',
            'doc_gender' => 'required',
            'doc_phone' => 'required|numeric',
            'doc_password' => 'required|min:6',
            'resume'   => 'required',
    ...
    public function test_report(Request $request)
    {
        $request->validate([
            ...
            'phone_no' => 'required|numeric|digits_between:6,12',
            'gender' => 'required',
    ...
    public function bookAppointment(Request $request)
    {
        ...
        $request->validate([
            ...
            'illness_information' => 'required',
            'patient_name' => 'required',
            'age' => 'required|numeric',
            'patient_address' => 'required',
            'phone_no' => 'required|numeric',
            'drug_effect' => 'required',
            'note' => 'required',
            'date' => 'required',
            'time' => 'required',
