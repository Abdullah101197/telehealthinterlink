...
Route::group(['middleware' => ['XssSanitizer']], function () {
    ...
    Route::get('/sent-to-admin', function () {
        return view('website.sent_to_admin');
    })->name('sent-to-admin');
    Route::any('/patient-login', [WebsiteController::class, 'patientLogin'])->name('patient_login');
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('downloadPfDF/{id}', [WebsiteController::class, 'downloadPDF']);
    ...
    Route::get('healthCare/doctor/{id}/signup/{p_name}', [healthCareController::class, 'healthCareDoctorSignup']);
    Route::get('healthCare/patient/{id}/signup/{p_name}', [healthCareController::class, 'healthCarePatientSignup']);

    Route::get('/healthCare/member/{name}', [healthCareController::class, 'healthCare_home'])->name('Health.Care.home');
