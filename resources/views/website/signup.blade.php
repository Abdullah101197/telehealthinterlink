                ...
                <div class="pt-5 flex">
                    ...
                    <div data-attr="HealthCare_Provider"
                        ...
                        <label for="bordered-radio-3"
                            class="text-sm font-medium text-[#666666]">{{ __('HealthCareProvider tt') }}</label>
                    </div>
                </div>
                <div class="tab-content contentDisplay" id="tabs-tabContent">
                        ...
                        <form action="{{ url('doctorRegister') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="pt-3">
                                ...
                                <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init>
                                    <input type="text" placeholder="dd/mm/yyyy" name="doc_dob"
                                        value="{{ old('doc_dob') }}"
                    ...
                    <div class="{{ $active == 'patient' ? 'active' : 'hide' }} patientDiv">
                        <form action="{{ url('signUp') }}" method="post">
                            ...
                            <div class="pt-3">
                                <label
                                    class="font-fira-sans text-black text-sm font-normal">{{ __('First Name') }}</label>
