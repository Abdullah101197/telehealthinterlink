<div class="w-full">
    ...
    <div class="pt-5 flex">
        ...
        @else
            ...
            @endphp
            @php
                $active = 'HealthCare_Provider';
            @endphp
        @endif
        <div data-attr="doctor"
            class="signupDiv w-1/3 cursor-pointer py-1 ml-2 border border-[#D8D8D8] {{ $active == 'doctor' ? 'active' : '' }}">
            <input {{ $active == 'doctor' ? 'checked' : '' }} id="bordered-radio-1" type="radio" value="doctor"
                name="signup_title" class="border-[#D8D8D8] cursor-pointer signup_title ml-2 text-blue-600">
        ...
        <div data-attr="patient"
            ...
            <input {{ $active == 'patient' ? 'checked' : '' }} id="bordered-radio-2" type="radio" value="patient"
                name="signup_title" class="border-[#D8D8D8] cursor-pointer signup_title ml-2 text-blue-600">
            <label for="bordered-radio-2" class="text-sm font-medium text-[#666666]">{{ __('Patient') }}</label>
        </div>
        <div data-attr="HealthCare_Provider"
            class="signupDiv sabir w-1/3 cursor-pointer py-1 ml-2 border border-[#D8D8D8] {{ $active == 'HealthCare_Provider' ? 'active' : '' }}">
            <input {{ $active == 'HealthCare_Provider' ? 'checked' : '' }} id="bordered-radio-3" type="radio"
                value="HealthCare_Provider" name="signup_title"
                class="border-[#D8D8D8] cursor-pointer signup_title ml-2 text-blue-600">
            <label for="bordered-radio-3"
                class="text-sm font-medium text-[#666666]">{{ __('HealthCare_Provider') }}</label>
        </div>
    </div>
