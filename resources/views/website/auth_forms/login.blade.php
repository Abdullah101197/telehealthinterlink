    ...
    <div class="grid grid-cols-2 gap-4 items-center">
        ...
        <div class="text-right">
            <a href="#" data-te-ripple-init="" data-te-ripple-color="light"
                class="rounded-none bg-primary tracking-wide px-4 py-2 text-white font-fira-sans font-normal text-sm authbackbtn"
                style="">
                <!-- Back Arrow SVG -->
    ...
    <form action="" method="post" id="popauthform">
        ...
        <div class="flex justify-center my-2">
            <div class="font-fira-sans font-medium text-sm leading-5 ">{{ __('Don’t have an account?  ') }} <a
                    href="#" class="text-primary text-normal authregbtn">{{ __('Signup') }}</a>
            </div>
        </div>
